...
const STATIC_HTML_BY_ROUTE: Record<string, string> = {
  ...
  '/cases': '<main class="min-h-screen bg-white"><section class="w-full max-w-[1200px] mx-auto px-4 py-16"><h1 class="text-3xl md:text-4xl font-semibold text-gray-900 mb-4">Success Stories</h1><p class="text-base md:text-lg text-gray-700 mb-4">Explore how businesses across industries achieve breakthroughs with TerraziPay stablecoin payment solutions. Representative customer cases from e-commerce, gaming, SaaS, MCN and more.</p><p class="text-base md:text-lg text-gray-700">This page summarizes typical customer scenarios and key metrics to help you quickly understand how TerraziPay brings real growth to different types of enterprises.</p></section></main>',
};
